	 ...
	 UI.prototype.__initMouseEventListener=function(){
	     ...
	     canvas.onmousemove = function(e){
		  	 if(self.hammer){
		        ...
		        self.hammer.x = even.clientX; self.hammer.x -=0; 
		        self.hammer.y = even.clientY; self.hammer.y -=0;
	          }
		 }
	     ...
	     canvas.onmouseup = function(e){
			 ...
			 self.__pengzhuang(self,even.clientX-0, even.clientY-0);
		 }		 
	 }
	 ...
	 */
	 UI.prototype.__caculateScore = function(self,type,x,y,i,j){
         ...
         if(type == this.currentType)
         {
             ...
             this.currentType = "mouse"+random;
             document.getElementById("quest-img").src = "images/pic"+random+".png";
             if(this.score > 5)
             {
                my.DOM.show(my.DOM.get('nextLoding'));
                 //例如当打到6个正确的蛋，通关，通关逻辑写在这里
